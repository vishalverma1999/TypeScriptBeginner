...
export class ListTemplate {
    constructor(private container: HTMLUListElement){};   // this will make a conainer which is html 'ul' element, like for example, const unOrdList = new ListTemplate(HTMLUListElement); and then we will use render method to append an dynamically created li into ul
